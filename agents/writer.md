...
**Before the first edit to any `.qmd`, whatever the section:** read
`.claude/references/quarto-authoring.md` — its gotchas ledger is the list of ways a `.qmd`
fails silently; write to the intersection of every format the document renders to.
