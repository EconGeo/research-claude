...
## Report
Return the scored report in the template's report format, plus the Claim–Evidence Table, as your final response. Do NOT write any files yourself — the dispatching skill saves the report to `quality_reports/reviews/writer-critic_<date>.md` and the table to the path above.
