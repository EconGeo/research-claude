...
**Status:** open (2026-09-24) — Part A is executable now under the recommended answers to
D1–D3; Parts B and C wait on D4–D5. Nothing here has run.
